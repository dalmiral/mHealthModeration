############
## README ## For any new MRT data set, all that (should) have to change are lines
  ## 11, set your working directory where your data is stored
  ## 21, new data set in working directory
  ## 31, randomization probability
  ## 36, design matrix for estimating numerator probability, \tilde p
  ## 47-49, design matrix for yt+1 (q-size working model + p-size causal model)
...
small <- if (n <= 50) {TRUE} else {FALSE}
  ...
  ## we use Peng's Hotelling's F but this is just t-test when we look at scalars!
  ## (need to write new code if one wishes to do a multivariate test ala Peng/Hotelling)
